...
public class Recipe5x5Drill extends SimpleMenu {

    public Recipe5x5Drill() {
        super(Rows.FIVE, Component.text("Recipe for the 5x5 drill"));
    }

    @Override
    public void onSetItems() {
        final ItemStack drillitem5x5 = DrillItem5x5.getminerv3();
        ...
        setItem(11, new ItemStack(Material.NETHERITE_BLOCK));
        setItem(12, new ItemStack(Material.NETHERITE_BLOCK));
        ...
        setItem(19, new ItemStack(Material.NETHERITE_BLOCK));
        setItem(20, new ItemStack(Material.NETHERITE_PICKAXE));
        setItem(21, new ItemStack(Material.NETHERITE_BLOCK));
        setItem(22, gray_outline);
        setItem(23, resultArrow);
        setItem(24, gray_outline);
        setItem(25, drillitem5x5);
        setItem(26, gray_outline);
        setItem(27, gray_outline);
        setItem(28, new ItemStack(Material.NETHERITE_BLOCK));
        setItem(29, new ItemStack(Material.NETHERITE_BLOCK));
